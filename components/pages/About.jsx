      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-20 container mx-auto py-24 md:h-screen">
        ...
        <div>
          ...
          >
            ...
            React, Next.js, Tailwind CSS, and various frontend frameworks like
            ShadCN, Material UI, and Framer Motion. I also have experience with
            other frontend tools and libraries that help enhance the
          ...
          >
            ...
            I'm always excited to tackle new frontend challenges.If you’re
            looking for a frontend developer with experience in both UI/UX
