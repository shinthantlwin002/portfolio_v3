...
const Contact = () => {
  return (
    <div
      id="contact"
      className="w-full h-[500px] md:h-[600px] bg-[#121B42] md:bg-[url('/images/map.png')] bg-cover relative"
    >
        ...
        <div className="container mx-auto flex flex-col justify-between h-full">
          <div>
            ...
            <m.h5
              ...
              className="text-lg md:text-2xl text-[#D9D9D9] mb-2"
            >
              Shin Thant Lwin
            </m.h5>
            <m.h4
          ...
          >
            ...
            <p className="text-base font-semibold text-white mb-2">
              Email - shinthantlwin.dev@gmail.com
            </p>
