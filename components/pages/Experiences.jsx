      ...
      content: (
        <div>
          <p className="text-[#B4B4B4] text-xs md:text-sm font-normal mb-8">
            At Circles X, I am a Fullstack developer specializing in React and
      ...
      content: (
        <div>
          <p className="text-[#B4B4B4] text-xs md:text-sm font-normal mb-4">
            I teamed up with a Fullstack developer and UI/UX designer on a{" "}
            <span className="font-semibold">Movie Project</span>, where I
            developed the Fullstack using React.
          </p>
